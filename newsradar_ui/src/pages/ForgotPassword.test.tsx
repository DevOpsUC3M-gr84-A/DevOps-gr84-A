...
describe('ForgotPassword', () => {
  ...
  test('muestra error si el email está vacío al enviar', async () => {
    ...
    expect(await screen.findByRole('alert')).toHaveTextContent('Debes introducir un email.');
  ...
  test('muestra mensaje por defecto cuando falla sin detail', async () => {
    ...
    expect(await screen.findByRole('alert')).toHaveTextContent('No se pudo procesar la solicitud. Inténtalo más tarde.');
  });
