...
@api_router.post(f"{API_PREFIX}/auth/login", response_model=TokenResponse, tags=["auth"])
...
@api_router.post(f"{API_PREFIX}/auth/register", response_model=User, tags=["auth"])
...
@api_router.get(f"{API_PREFIX}/users", response_model=List[User], tags=["users"])
def list_users(_: UserInDB = Depends(get_current_user)) -> List[User]:
	return [sanitize_user(user) for user in users_store.values()]


@api_router.post(f"{API_PREFIX}/users", response_model=User, status_code=201, tags=["users"])
...
@api_router.get(f"{API_PREFIX}/users/{{user_id}}", response_model=User, tags=["users"])
...
@api_router.put(f"{API_PREFIX}/users/{{user_id}}", response_model=User, tags=["users"])
...
@api_router.get(f"{API_PREFIX}/roles", response_model=List[Role], tags=["roles"])
def list_roles(_: UserInDB = Depends(get_current_user)) -> List[Role]:
	return list(roles_store.values())


@api_router.post(f"{API_PREFIX}/roles", response_model=Role, status_code=201, tags=["roles"])
...
@api_router.get(f"{API_PREFIX}/roles/{{role_id}}", response_model=Role, tags=["roles"])
...
@api_router.put(f"{API_PREFIX}/roles/{{role_id}}", response_model=Role, tags=["roles"])
...
@api_router.get(f"{API_PREFIX}/categories", response_model=List[Category], tags=["categories"])
def list_categories(_: UserInDB = Depends(get_current_user)) -> List[Category]:
	return list(categories_store.values())


@api_router.post(f"{API_PREFIX}/categories", response_model=Category, status_code=201, tags=["categories"])
...
@api_router.get(f"{API_PREFIX}/categories/{{category_id}}", response_model=Category, tags=["categories"])
...
@api_router.put(f"{API_PREFIX}/categories/{{category_id}}", response_model=Category, tags=["categories"])
...
@api_router.post(f"{API_PREFIX}/stats", response_model=Stats, status_code=201, tags=["stats"])
...
@api_router.get(f"{API_PREFIX}/stats/{{stats_id}}", response_model=Stats, tags=["stats"])
...
@api_router.put(f"{API_PREFIX}/stats/{{stats_id}}", response_model=Stats, tags=["stats"])
