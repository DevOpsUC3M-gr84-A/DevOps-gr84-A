...
from app.api import rss  # Importamos el nuevo módulo de rss

# En caso de que tengas alertas añadidas: from app.api import alerts

api_router = APIRouter()

API_PREFIX = "/api/v1"

# Aquí registramos el router de canales RSS
api_router.include_router(rss.router, prefix=API_PREFIX)
